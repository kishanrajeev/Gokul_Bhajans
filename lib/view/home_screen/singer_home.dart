...
class SingerHome extends StatefulWidget {
  @override
  _SingerPageState createState() => _SingerPageState();
}

class _SingerPageState extends State<SingerHome> {
  List<dynamic> _songs = [];
  ...
  void initState() {
    ...
    rootBundle.loadString('assets/mainjson.json').then((data) {
      ...
      _jsonstr = _songs
          .map((song) => song["SINGER"] as String)
          .toSet()
          .toList();
      _jsonstr.sort();
      setState(() {});
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => SongsPage(
                            ...
                            songs: _songs
                                .where((song) => song["SINGER"] == _jsonstr[index])
                                .toList(),
                          ),
                        ),
                      );
